...
if ($RunScriptedProbes) {
    ...
    $probeRuns.Add((Invoke-ScriptedProbe -Name "playable-world" -Ticks 240 -Scene "scenes/playable-world.scene" -RequiredSummaryMarkers @("player_visual=present", "player_visual_overlays=", "playable_shots=", "particles=", "transient_bursts=", "max_transient_bursts=", "fps=", "frame_ms=", "frame_p99_ms=", "frame_low1_fps=", "frame_jitter_ms=", "frame_samples=", "sim_hz=", "camera_followed=True", "render_camera_synced=True", "render_camera=", "720x480", "player_left_ground=True", "player_air_control=True", "player_ground_samples=", "player_air_samples=", "max_particles=", "hud_blocked=none") -Root $root -OutputRoot $probeRoot))
