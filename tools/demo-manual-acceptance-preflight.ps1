...
if ($RunScriptedProbes) {
    ...
    $probeRuns.Add((Invoke-ScriptedProbe -Name "route-attempt" -Ticks 220 -Scene "scenes/lava-mine.scene" -RequiredSummaryMarkers @("pause_open=False", "hud_blocked=none", "render_camera_synced=True", "player_x_range=") -Root $root -OutputRoot $probeRoot -ExtraArguments @("--scripted-window-route")))
