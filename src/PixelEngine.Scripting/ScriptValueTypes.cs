...
/// <summary>
/// 刚体 joint 句柄；具体有效性由 Physics 后端维护。
/// </summary>
/// <param name="Value">运行时 joint id。</param>
public readonly record struct JointHandle(int Value);

/// <summary>
/// 脚本侧 revolute joint 参数。
/// </summary>
...
public readonly record struct RevoluteJointDesc(
