    ...
    public static GuiThemeTokens GetTokens(GuiThemeKind theme)
    {
        return theme switch
        {
            ...
            GuiThemeKind.Unity6Dark => new GuiThemeTokens(
                ...
                TabRounding: 0f,
                DockingSeparatorSize: 2f,
                WindowPadding: new Vector2(7f, 6f),
                FramePadding: new Vector2(6f, 3f),
                ItemSpacing: new Vector2(6f, 4f),
                Text: Rgb(0xDC, 0xDC, 0xDC),
                TextDisabled: Rgb(0x8C, 0x8C, 0x8C),
                WindowBg: Rgb(0x38, 0x38, 0x38),
                PanelBg: Rgb(0x2F, 0x2F, 0x2F),
                FrameBg: Rgb(0x24, 0x24, 0x24),
                Header: Rgb(0x3F, 0x3F, 0x3F),
                HeaderHovered: Rgb(0x4A, 0x4A, 0x4A),
                HeaderActive: Rgb(0x55, 0x55, 0x55),
                Button: Rgb(0x43, 0x43, 0x43),
                ButtonHovered: Rgb(0x50, 0x50, 0x50),
                ButtonActive: Rgb(0x5C, 0x5C, 0x5C),
                Accent: Rgb(0x3D, 0x6D, 0x99),
                Border: Rgb(0x1F, 0x1F, 0x1F)),
