    ...
    public void DemoManualAcceptancePreflightRejectsScriptedProbeSummaryBelowSemanticThreshold()
    {
        ...
        try
        {
            ...
            string harness = string.Concat(
                ...
                "$goodEditor = '脚本化窗口输入摘要：frames=180, frame_samples=120, editor_enabled=True, editor_running=True, editor_panels=12, editor_bridge_frames=120, render_camera_synced=True, scripted_play_entered=True, scripted_play_exited=True, scripted_scene_saved=True。'\n",
                ...
                "}\n",
                "$badEditor = '脚本化窗口输入摘要：frames=180, frame_samples=120, editor_enabled=True, editor_running=False, editor_panels=12, editor_bridge_frames=120, render_camera_synced=True, scripted_play_entered=True, scripted_play_exited=True, scripted_scene_saved=True。'\n",
                "try {\n",
