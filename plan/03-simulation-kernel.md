...
### 3.12 结构破坏模型：`Damage` lane 与 `ApplyStructuralDamage`（demo-playability 增补，字节预算评审已落地）
...
破坏模型（demo-playability，§3.12）新增依赖：
