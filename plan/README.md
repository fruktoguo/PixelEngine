...
| 19 独立编辑器应用 | - [!] | 顶层壳/GameObject authoring/build-player 子进程编排、编辑器内 Build/Build-And-Run 验证、失败诊断、取消后重跑、构建 UI 响应/设置持久化、玩家包解耦、plan/12 复用面板与 Play/Edit 短跑冒烟已落地；菜单流程与人工验收待补 |
