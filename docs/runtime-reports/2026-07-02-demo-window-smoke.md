...
本机真实窗口路径能装配 Content、Simulation、Physics、Audio、Scripting、Rendering 与 Input 后端，并稳定执行 120 个 Engine tick 后正常释放退出。

该验证只证明窗口运行态 smoke 通过；不替代真实玩家输入手感、GUI 鼠标交互、完整关卡通关、视觉/音频听感、长跑 60fps 或 native 泄漏审计。
